...
KyrieViolinoI = {
  \relative c' {
    ...
    e2 r4 g8( e)
    \appoggiatura d4 cis2^\missgrace d4 fis8 a, %65
    a2 g4.\trillE fis16 g
    fis4 d\fE fis a
    d d, fis a
    d a8 fis a4 fis8 d
    ...
    a4 \appoggiatura cis16 h8^\missgrace a16 g fis4 \appoggiatura a16 g8 fis16 e
    d2 a4 fis'
    d8 a fis' a, d a a' a, %115
    d2 a4 fis'
    d8 a fis' a, d a a' a,
    d4 \appoggiatura e'16 d8^\missgrace cis16 h a4 \appoggiatura e'16 d8^\missgrace cis16 h
    a4 \appoggiatura cis16 h8^\missgrace a16 g fis4 \appoggiatura a16 g8 fis16 e
    ...
    a8( c) h( d) \appoggiatura d c4^\missgrace h8( a)
    a2( h4) r
    d2 h8( c d e)
...
QuiTollisViolinoI = {
  \relative c' {
    ...
    g16( d) d( c) c( h) h( a) \noBreak
    \once \slurDashed a4( g8) r\fermata %185
    g16\p g g g g g g g \noBreak
    g g g g g g g g
    g4 r8 d'
    ...
    fis4 r8 \appoggiatura a32 g16^\missgrace fis32 g
    fis4 r8 \appoggiatura a32 g16^\missgrace fis32 g %225
    fis4 r
...
BenedictusViolinoI = {
  \relative c' {
    ...
    R4.
    r4 gis'32( a16.)
    \appoggiatura gis32 fis16( e32 d) cis8[ h]
    cis'-! cis( gis) %20
    a-! a( e)
    fis16( d) d([ cis)] cis( h)
    \appoggiatura h8 a4 r8
    a4\p \appoggiatura cis32 h16( a32 gis)
    a16.([ d32)] cis8 r %25
    cis4 \appoggiatura e32 d16( cis32 h)
    ...
    cis4 r8
    fis( d) r16 fis-!
    e8( cis) r16 e-\parenthesize-!
    \appoggiatura e8 d4.\trill-\missgrace
    cis16( h) d([ cis)] fis(^\critnote e) %35
    \appoggiatura e8 d4.\trill-\missgrace
    cis4 r8
    r e e
    r e e
    ...
    r a, a
    gis4 r8
    r8 e'32([ dis e fis)] e8
    r16 e e32([ dis e fis)] e8-!
    fis, gis a %45
    \appoggiatura a gis4 r16 cis
    h4 gis16( h)
    a4 fis8
    ...
    R4.
    r4 gis'32( a16.)
    \appoggiatura gis32 fis16( e32 d) cis8[ h]\trill
    cis'-! cis( gis) %140
    a-! a( e)
    fis16( d) d([ cis)] cis( h)
    cis'8-! cis( gis)
...
DonaNobisViolinoI = {
  \relative c' {
    ...
    h''8\fE d, d d d cis cis4
    fis8 fis fis fis fis e e e %95
    e4 d d cis8 h \noBreak
    cis1\fermata \bar "||"
    ...
    fis8. g16 a8 a
    a d4 cis8
    cis16( h) h( a) a( g) g( fis) %105
    fis4( e8) r
    fis,8. g16 a8 a
    a( fis) r \slurDashed fis16( a)
    e( a fis a) g( a e a) \slurSolid
    d8 a r fis' %110
    e8. fis16 g8 g
    ...
    cis( h) r4
    cis,4\p d16( h gis e)
    <e e'>4 d'16( h gis e) %140
    cis'4 d16( h gis e)
    <e e'>4 \once \slurDashed d'16( h gis e)
    cis'8.\f d16 e8 e
    fis8. gis16 a8 a
    cis,16 a' cis, a' cis, a' cis, a' %145
    h, gis' h, gis' h, gis' h, gis'
    a4 gis16(\pE e gis e)
    a4 gis16( e gis e)
    a4 gis16( e gis e)
    a8 dis,, dis dis %150
    ...
    e4 f
    e r8 e
    cis'4 d16( h gis e) %155
    <e e'>4 d'16( h gis e)
    cis'4 d16( h gis e)
    <e e'>4 d'16( h gis e)
    cis'8.\fE d16 e8 e
    fis8. gis16 a8 a %160
    cis,16 a' cis, a' cis, a' cis, a'
    h, gis' h, gis' h, gis' h, gis'
    ...
    d,4 cis16( a cis a)
    d4 cis16( a cis a) %200
    d8 a \appoggiatura g16 fis8 e16 d
    <a' e a,>4 r8 a\p
    a a a a
    a a r a
    a a a a %205

...
QuiTollisSopranoNotes = {
  \relative c' {
    ...
    R2*36 %184
    r4 r8\fermata \mvTr d\pE^\solo %185
    g8.([ h32 a)] g8 d
    g8.([ h32 a)] g8 d
    d16[( g) g( h)] h([ d)] g([ d)]
...
BenedictusSopranoNotes = {
  \relative c' {
    ...
    R4.*23 %23
    \mvTr a'4\pE^\solo \appoggiatura cis32 h16([ a32 gis)]
    a16.([ d32)] cis8 r %25
    ...
    h4 \appoggiatura dis32 cis16[^\missgrace h32 cis] %50
    dis4 \appoggiatura fis32 e16[^\missgrace dis32 e]
    fis8[ fis e]
    dis[ dis cis]
    h[ h] a
    \appoggiatura a8 gis4^\missgrace h8 %55
    h16([ e)] e8 r16 h
    cis e e8 r
    fis,([ gis)] a
...
DonaNobisSopranoNotes = {
  \relative c' {
    ...
    d fis fis4~
    fis8[ e16 d] e8[ d]
    cis4 \once \tieDashed d~
    d8 cis r4
    R2*3 %177
    r4 r8 d~
    d4. c8
    c? h r \once \tieDashed e~ %180
    e4. d8
    d cis! r4
    e2
    fis4 r
